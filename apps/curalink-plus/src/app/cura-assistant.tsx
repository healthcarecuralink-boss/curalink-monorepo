  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        title: { fontFamily: curalinkPlusFonts.heading, fontSize: 17, color: colors.ink },
        ...
        emptyIcon: { width: 56, height: 56, borderRadius: 20, backgroundColor: "#E8F5F0", alignItems: "center", justifyContent: "center" },
        emptyTitle: { fontFamily: curalinkPlusFonts.headingSemibold, fontSize: 15, color: colors.ink, textAlign: "center" },
        emptyBody: { fontSize: 12.5, color: colors.muted, textAlign: "center", lineHeight: 18 },
    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === "ios" ? "padding" : undefined}>
      <View style={styles.header}>
        ...
        <View>
          ...
          <Text style={styles.subtitle}>Ask about visits, prescriptions, or payouts</Text>
        </View>
      </View>
        ...
        {messages === undefined ? (
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyBody}>
              Ask me about your workflow, visits, or account — try one of the prompts below.
            </Text>
          </View>
        ) : (
