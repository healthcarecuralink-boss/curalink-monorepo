...
export default function NotificationsScreen() {
  ...
  const styles = useMemo(
    ...
    title: { flex: 1, fontFamily: curalinkFonts.heading, fontSize: 20, color: colors.ink },
    ...
    notificationBody: { fontSize: 12, color: colors.ink2, marginTop: 2, lineHeight: 17 },
    notificationMeta: { fontSize: 10.5, color: colors.muted2, marginTop: 4 },
  ...
  async function handleTap(id: string, data: unknown) {
        ...
        <View style={{ gap: 8 }}>
          {notifications.map((notification) => (
            <Pressable
              ...
              onPress={() => void handleTap(notification.id, notification.data)}
            >
